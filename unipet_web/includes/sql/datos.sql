...
INSERT INTO `animales` (`ID`, `nombre`, `nacimiento`, `tipo`, `raza`, `sexo`, `peso`, `ingreso`, `protectora`, `historia`, `DNI`, `urgente`) VALUES
(1, 'Winkie', '2015-09-06', 'perro', 'Teckel', 'hembra', '4.2', '2021-04-15', 1, 'Mucho texto', '54494722V', 0),
(2, 'Coco', '2021-04-15', 'gato', NULL, 'hembra', '3.0', '2021-04-15', 1, NULL, NULL, 1),
(3, 'Thor', '2021-04-15', 'perro', 'Labrador', 'macho', '32.0', '2021-04-15', 1, 'TEXTO', '00000002A', 0),
...
(10, 'Ava', '2021-04-15', 'gato', 'Scottish Fold', 'hembra', '2.9', '2021-04-15', 2, 'En el momento que Rares entró a la protectora, él y Ava se miraron y su conexión fue instantáneo, forjando una unión que nada los separará.', '00000003A', 0),
...
(14, 'Frida', '2021-04-15', 'gato', 'Persa', 'hembra', '3.8', '2021-04-15', 1, 'Desde que conoció a Enrique, se volvió el gato más feliz de toda España.', '00000000A', 0),
...
(17, 'Hannah', NULL, 'perro', NULL, 'hembra', NULL, '2021-04-16', 2, NULL, NULL, 0);
