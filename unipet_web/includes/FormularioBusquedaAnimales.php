...
EOF;
	if (!$this->enviado) $camposFormulario .= listaAnimales(es\ucm\fdi\aw\Animal::buscaAnimales(null,"Todos"));
  ...
  protected function procesaFormulario($datos)
  {
	...
	$busqueda = es\ucm\fdi\aw\Animal::buscaAnimales($nombreAnimal,$tipoAnimal);
	if ($busqueda != null) {
